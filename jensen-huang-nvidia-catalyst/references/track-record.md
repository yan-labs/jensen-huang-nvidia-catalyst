...
|---|---:|---:|---:|---|
| Tier 1 product roadmap | 4 | 3/3 scored | 0 | GTC/RTX Spark, Vera CPU/DGX Station, and physical-AI/robotaxi clusters all hit T+1d on NVDA-led public quote context; new H2 roadmap/surprise-product row is pending. |
