...
|---|---:|---:|---:|---|
| Tier 1 product roadmap | 2 | 0 | 0 | Vera CPU/DGX Station and physical-AI/robotaxi clusters pending T+1d/T+1w scoring. |
| Tier 1 demand/capacity | 2 | 0 | 0 | Vera Rubin full-production and DSX AI-factory infrastructure rows pending T+1d/T+1w scoring. |
| Tier 2 customer/supplier confirmation | 1 | 0 | 0 | Enterprise software-agent partner row pending; secondary software impact is lower conviction than NVDA platform signal. |
